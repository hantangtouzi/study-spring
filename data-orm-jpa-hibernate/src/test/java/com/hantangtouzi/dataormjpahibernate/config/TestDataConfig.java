package com.hantangtouzi.dataormjpahibernate.config;
...
@ComponentScan("com.hantangtouzi.dataormjpahibernate")
public class TestDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.hantangtouzi.datajdbc.entity");
